"""Run cavity L0-L3 TEprop (new local-segment metric + closed contour) at alpha=4."""
...
CASES = [('proper_cav_L0_TEprop','L0'),('proper_cav_L1_TEprop','L1'),
         ('proper_cav_L2_TEprop','L2'),('proper_cav_L3_TEprop','L3')]
...
json.dump(results, open(f"{F}/te_proper_results.json",'w'), indent=1)

...
handover. Section~\ref{sec:calib} anchors the amplification kernel to canonical
stability limits and fixes the freestream-turbulence seed map
$\chi_\infty(Tu)$---Mack's $e^N$ correlation adopted wholesale.

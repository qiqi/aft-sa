...
\begin{figure}[tp]
  ...
  (matched to $N_\mathrm{crit}\!=\!9$). \emph{Top row}:
  wall-normal-probe maximum of $Re_\Omega$ (log axis). \emph{Second row}:
  wall-normal-probe maximum of $\Gamma$. \emph{Third row}: in-BL maximum
  ...
  the vertical dotted lines at mfoil's $x_\mathrm{tr}$. \emph{Fourth row}:
  $-C_p$. \emph{Bottom row}: \emph{signed} $C_f$ (positive downstream, negative

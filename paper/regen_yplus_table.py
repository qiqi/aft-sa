"""Coarse-mesh (y+) robustness table for Sec. III.C (tau_D-calibrated model).
...
with the destruction width tau_D=1.36 matching B to standard SA at every
resolution. Prints the Table~\ref{tab:yplus} rows.
"""
import numpy as np

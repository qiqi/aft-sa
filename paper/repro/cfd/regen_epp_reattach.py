...
signed C_f crosses back into positive (zero-crossing) -- the physical return of
attached flow, not an arbitrary threshold. The experiment is the oil-flow turbulent-
...
def reattach(x, cf, thr=0.0, xlo=0.05, xhi=0.85):
    """Most-downstream upward zero-crossing of C_f within the LSB window: the
    physical return of attached flow (C_f back into positive). None if the
    surface never separates in the window."""

...
Model env (all SA-AI cases): the canonical 'ai' variant from run_vg_all.py, which
is exactly ``saai_env.canonical_ai_env()`` (AI_SA=1, AI_VG_GATE=3,
AI_RATESCALE=0.19, AI_GCRIT=1.055, AI_SIGMOIDSLOPE=8.0, AI_REOMEGA_FLOOR=290.0,
AI_CLIFF_LAMBDA_SLOPE=5.9) + per-case AI_CHI_INF/AFT_CHI_INF + AI_LAMINAR_SLOWDOWN.

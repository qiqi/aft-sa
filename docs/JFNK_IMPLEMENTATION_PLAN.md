...
This document outlines the implementation plan for adding a Jacobian-Free Newton-Krylov solver with GMRES(m) and block-Jacobi preconditioning to the SA-AI RANS solver.

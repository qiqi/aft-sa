...
AI_SA=1, AI_LAMINAR_SLOWDOWN=0.01. New dirs flatplate_sphere_Tu#### (old dirs kept).
"""
import os, sys, shutil, threading, time, json
sys.path.insert(0, "/home/qiqi/flexcompute/flexfoil/rans")
sys.path.insert(0, "/home/qiqi/flexcompute/sa-ai/scripts")
...
def case_dir(Tu): return f"{B}/flatplate_sphere_Tu{int(round(Tu*1000)):04d}"
...
if __name__ == '__main__':
    ...
    sem = threading.Semaphore(4); lock = threading.Lock(); results = {}
    threads = [threading.Thread(target=run_case, args=(Tu, i % 4, sem, lock, results))
